...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~=nil and PlayerData.job.name=='ballas') or (PlayerData.job2 ~=nil and PlayerData.job2.name=='ballas') then
      ...
      for k,v in pairs(Config.BallasStations) do
        ...
        if (Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and PlayerData.job.grade_name == 'boss') or (Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' and PlayerData.job2.grade_name == 'boss') then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if (IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and (GetGameTimer() - GUI.Time) > 150) or (IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' and (GetGameTimer() - GUI.Time) > 150) then
   ...
   if (IsControlPressed(0,  Keys['F5']) and PlayerData.job ~= nil and PlayerData.job.name == 'ballas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ballas_actions') and (GetGameTimer() - GUI.Time) > 150) or (IsControlPressed(0,  Keys['F5']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ballas_actions') and (GetGameTimer() - GUI.Time) > 150) then
